...
- Список: жирный заголовок, по каждой задаче — название и стрик, жирная подсказка;
  кнопки задач (по 2 в ряд) + стрелки + «‹ Назад». «Все задачи» — все активные
  задачи (как /stats), «Задачи на сегодня» — задачи, запланированные на сегодня.
...
async def _section_data(
    ...
    «Все задачи» — все активные задачи (как /stats).
    «Задачи на сегодня» — задачи, запланированные на сегодня.
    """
